   ...
   protected void setUp() throws Exception
    {
        ...
        this.getDriverFromEnv(capabilities);
    ...
    protected void backroudApp(int seconds)
    {
    ...
    private void getDriverFromEnv(DesiredCapabilities capabilities) throws Exception
    {
        String platform = System.getenv("PLATFORM");
        ...
        if (platform.equals(PLATFORM_ANDROID)){
            ...
            driver  = new IOSDriver(new URL(AppiumURL), capabilities);    }  else {
